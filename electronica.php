                       ...
                       /* connect to phpmyadmin - ready */   
							...
							while($row = $results->fetch_assoc()){
								...
								<div class="product-main simpleCart_shelfItem">
									<a href="single.html" class="mask"><img class="img-responsive zoom-img" src="'.$row["imgFile"].'" alt="" /></a>
				...
				<!--	<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								...
								<p>A06B-0021-B17</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">FANUC</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
